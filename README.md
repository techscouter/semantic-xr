...
* Potential **security** issues for consumers of semantic data from unverified sources. Further research into using digital signatures and checksums might be useful to enable verification of the source and integrity of Semantic-XR documents. 
* Potential **abuse in competitive games**.
* **Thorough testing with people with disabilities**.
* **Thorough testing with developers** of XR experiences and assistive technologies (including developers with disabilities).
